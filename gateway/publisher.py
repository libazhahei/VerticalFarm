...
class ControlCommandPublisher: 
    ...
    def __init__(self, mqtt_client: MQTTClient, is_alive_func: Callable[[int], Awaitable[bool]], max_retries: int = PUBLISH_RESENT_MAX_RETRIES, timeout: float = PUBLISH_TIMEOUT_SECONDS):
