...
class AIDailyReport(Model):
    ...
    Attributes:
        ...
        content (str): Detailed content of the report.
    """
...
class AIDailyStrategy(Model):
    """
    Represents the daily strategy generated by the AI for a board.

    Attributes:
        id (int): Unique identifier for the AI strategy.
        strategy_date (date): Date for the strategy.
        content (str): Detailed content of the strategy.
    """
